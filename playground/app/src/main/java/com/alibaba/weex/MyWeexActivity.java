...
/**
 * Created by syp on 2016/8/15.
 */
public class MyWeexActivity extends AbstractWeexActivity {

    private static final int CAMARA_PERMISSION_REQUEST_CODE = 0x1;
    private static final String TAG = "IndexActivity";
    private static final String DEFAULT_IP = "192.168.7.112";
    private static String CURRENT_IP= "192.168.7.111"; // your_current_IP
    private static final String WEEX_INDEX_URL = "http://"+CURRENT_IP+":80/examples/build/acgj.js";
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mReloadReceiver=new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                createWeexInstance();
                if(TextUtils.equals(CURRENT_IP,DEFAULT_IP)){
                    renderPage(WXFileUtils.loadFileContent("index.js", MyWeexActivity.this),WEEX_INDEX_URL);
                }else{
                    renderPageByURL(WEEX_INDEX_URL);
                }
                mProgressBar.setVisibility(View.VISIBLE);
